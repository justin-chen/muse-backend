...
module.exports = {
  login: (req, res) => {
    ...
    const scope = 'user-read-private user-library-read user-follow-read user-read-email user-top-read playlist-read-private playlist-modify-private playlist-modify-public';
